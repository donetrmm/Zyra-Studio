        ...
        ideas: [
          {
            ...
            invented: [],
            scenes: [
              { scenePrompt: 'A wall ignites and the artwork appears on it', durationS: 5, sceneSummary: null, beatRole: 'beat' as const },
              { scenePrompt: 'The artwork hangs above a sofa in a living room', durationS: 4, sceneSummary: null, beatRole: 'beat' as const },
            ],
        ...
        ideas: [
          {
            ...
            scenes: [
              { scenePrompt: 'A wall ignites and the artwork appears', durationS: 5, sceneSummary: null, beatRole: 'beat' as const },
              { scenePrompt: 'The logo glows over the illuminated artwork', durationS: null, sceneSummary: null, beatRole: 'beat' as const },
            ],
      ...
      directedInput({
        ideas: [{
          ...
          scenes: [{
            ...
            durationS: 4, sceneSummary: null, beatRole: 'beat' as const,
          }],
          sequenceLabel: 'X',
        }],
      }),
  ...
  it('una idea-secuencia produce N items con mismo sequenceId, sceneIndex 0..N-1 y misma fecha', () => {
    ...
    const items = buildDirectedPlan({
      ideas: [{
        ...
        characterIds: [], invented: [],
        scenes: [
          { scenePrompt: 'Scene one with the product', durationS: 4, sceneSummary: 'uno', beatRole: 'beat' as const },
          { scenePrompt: 'Scene two with the product', durationS: 6, sceneSummary: 'dos', beatRole: 'beat' as const },
          { scenePrompt: 'Scene three with the product', durationS: 5, sceneSummary: 'tres', beatRole: 'beat' as const },
        ],
