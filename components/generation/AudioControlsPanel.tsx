...
const MODEL_LABEL: Record<(typeof TTS_MODELS)[number], string> = {
  eleven_multilingual_v2: 'Multilingual v2',
  eleven_flash_v2_5: 'Flash v2.5',
  eleven_v3: 'Eleven v3',
};

// Estimación grosera del tiempo de síntesis: base + chars/throughput.
// ElevenLabs procesa ~80 chars/seg en Flash, menos en v2/v3. Cap a 60s.
function estimateAudioEta(text: string, modelId: (typeof TTS_MODELS)[number]): number {
