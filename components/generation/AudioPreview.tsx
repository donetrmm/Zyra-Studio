...
// Props expandidas (modelId, voiceId, etc.) las recibimos para mantener
// compatibilidad con AudioGenerator, pero por ahora replicamos exactamente
// el comportamiento de fase 3 donde el wave SÍ se veía en mobile.
